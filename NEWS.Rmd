...
*  Fixed a bug occuring when using custom outcome models in the `gformula()` function (Thanks to @Keling-Wang)
...
*  Fixed a bug occuring when using covariates of type `"categorical time"`
